...
export default defineConfig({
  ...
  format: ["esm", "cjs"],
  dts: {
    // @ts-expect-error -- cjsReexport is in tsdown source but missing from bundled d.ts
    // TODO: remove when tsdown ships the type (https://github.com/nicholascyang/tsdown/issues/…)
