...
- Date: 2026-08-23
- Template side: worktree `[template-repo]` @ `7b51545` (`chore/template-platform`)
- Consumer side: `[consumer-repo]` (working tree, untouched)
...
`eslint-config-rebeccastevens` and `eslint-plugin-functional` (read from `[consumer-repo]/<name>/`).
